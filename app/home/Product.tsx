        ...
        <div className={`flex-1 reveal-right ${productReveal.visible ? "revealed" : ""}`}>
          ...
          <div className="mt-10 grid grid-cols-2 gap-4">
            {[
              {
                icon: (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7C6FF7" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              {
                icon: (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#53A3FF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              >
                <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4" style={{ backgroundColor: iconBg }}>
                  {icon}
                </div>
