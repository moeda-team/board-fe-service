    ...
    <>
      ...
      <section id="testimonials" className="py-28 px-8 overflow-hidden bg-white">
        <div ref={testimonialsReveal.ref} className="max-w-7xl mx-auto w-full">
          {/* Header */}
          <div
            className={`flex items-end justify-between mb-14 reveal-up ${testimonialsReveal.visible ? "revealed" : ""}`}
          >
            <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    {t.avatar ? (
                      ...
                      <div
                        className={`w-9 h-9 rounded-full ${t.avatarBg} flex items-center justify-center text-white text-[11px] font-bold shrink-0`}
                      >
                        {t.initials}
                      </div>
                    )}
          ...
          {/* Bottom CTA strip */}
          <div
            className={`mt-14 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50 border border-gray-100 rounded-2xl px-8 py-6 reveal-up stagger-4 ${testimonialsReveal.visible ? "revealed" : ""}`}
          >
